...
<body>
    <header>
        <div class="container-fluid ">
            <div class="d-flex align-item-center py-2">
                <img class="g_logo me-2" src="https://loghi-famosi.com/wp-content/uploads/2020/09/Google-Logo.png" alt="logo">
            ...
            <nav>
                <ul class="d-flex ps-0 mb-0">
                    ...
                    for ($i = 0; $i < count($navLink); $i++) {
                        ...
                        echo "<li class='list-group-item border-0'><a class='' href='$href'>
                  $text 
                </a></li>";
                    }
                    ?>
    ...
    <main>
        <div class="container">
            ...
            foreach ($questions as $question) {
                //var_dump($question);
                $tag = $question["title_tag"];
                $title = $question["title"];
                $answer = $question["answer"];

                echo "<div>
                        <$tag class='mb-4'>$title</$tag> 
                    ";
